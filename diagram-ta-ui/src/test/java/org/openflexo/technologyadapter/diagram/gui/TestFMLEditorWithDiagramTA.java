...
public class TestFMLEditorWithDiagramTA extends OpenflexoFIBTestCase {
	...
	public static void initGUI() {
		gcDelegate = new SwingGraphicalContextDelegate(TestFMLEditorWithDiagramTA.class.getSimpleName());
	}
