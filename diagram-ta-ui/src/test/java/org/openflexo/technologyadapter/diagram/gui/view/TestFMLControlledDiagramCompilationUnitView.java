...
/**
 * Test FMLControlledDiagramCompilationUnitView.fib
 * 
 * @author sylvain
 * 
 */
@RunWith(OrderedRunner.class)
public class TestFMLControlledDiagramCompilationUnitView extends OpenflexoFIBTestCase {
	...
	public void testLoadWidget() {
		...
		fibResource = DiagramCst.FML_CONTROLLED_DIAGRAM_COMPILATION_UNIT_VIEW_FIB;
	...
	public void loadConcepts() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		flexoConceptA = virtualModel.getFlexoConcept("TestConcept");
	...
	public void testInstanciateWidget() {
		...
		FMLControlledDiagramFMLFIBController fibController = (FMLControlledDiagramFMLFIBController) widget.getController();
		...
		if (fibController.getSelectedDiagram() == null && fibController.getSelectedPalette() == null) {
			if (fibController.getDiagramSpecification(virtualModel.getCompilationUnit()) != null
					&& fibController.getDiagramSpecification(virtualModel.getCompilationUnit()).getExampleDiagrams().size() > 0) {
				fibController.setSelectedDiagram(
						fibController.getDiagramSpecification(virtualModel.getCompilationUnit()).getExampleDiagrams().get(0));
			}
	...
	public static void initGUI() {
		gcDelegate = new SwingGraphicalContextDelegate(TestFMLControlledDiagramCompilationUnitView.class.getSimpleName());
	}
