...
public class TestFMLEditorWithDiagramTAXMLVersion extends OpenflexoFIBTestCase {
	...
	public void loadFMLResource() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		VirtualModel rootVM = vpLib
				.getVirtualModel("http://openflexo.org/test/TestResourceCenter/TestControlledDiagramViewPointXMLVersion.fml");
		assertNotNull(rootVM);
		VirtualModel virtualModel = vpLib.getVirtualModel(
				"http://openflexo.org/test/TestResourceCenter/TestControlledDiagramViewPointXMLVersion.fml/TestVirtualModelXMLVersion.fml");
	...
	public static void initGUI() {
		gcDelegate = new SwingGraphicalContextDelegate(TestFMLEditorWithDiagramTAXMLVersion.class.getSimpleName());
	}
