...
public class CreateFMLClassDiagramInitializer extends ActionInitializer<CreateFMLClassDiagram, VirtualModel, FMLObject> {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(ControllerActionInitializer.class.getPackage().getName());

	public CreateFMLClassDiagramInitializer(ControllerActionInitializer actionInitializer) {
		super(CreateFMLClassDiagram.actionType, actionInitializer);
	}

	@Override
	protected FlexoActionRunnable<CreateFMLClassDiagram, VirtualModel, FMLObject> getDefaultInitializer() {
		return (e, action) -> {
			Wizard wizard = new CreateFMLClassDiagramWizard(action, getController());
