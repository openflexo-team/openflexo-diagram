...
package org.openflexo.technologyadapter.diagram.fml.xml;
...
public class TestInstantiateControlledDiagramVirtualModelXMLVersion extends OpenflexoProjectAtRunTimeTestCase {
	...
	public void testLoadViewPoint() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		assertNotNull(vpLib);
		viewPoint = vpLib.getVirtualModel("http://openflexo.org/test/TestResourceCenter/TestControlledDiagramViewPointXMLVersion.fml");
		assertNotNull(viewPoint);

		virtualModel = viewPoint.getVirtualModelNamed("TestVirtualModelXMLVersion");
